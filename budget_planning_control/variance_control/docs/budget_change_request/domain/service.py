...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['budget_plan', 'variance_report'], 'action_targets': {'create': None, 'submit': 'in_review', 'review': 'in_review', 'approve': 'approved', 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

"""Action handler seed for budget_change_request:create."""
...
ACTION_ID = "create"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': None}

"""Action handler seed for budget_change_request:approve."""
...
ACTION_ID = "approve"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': 'approved'}

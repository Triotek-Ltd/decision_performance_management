"""Action handler seed for budget_change_request:reject."""
...
ACTION_ID = "reject"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': 'rejected'}

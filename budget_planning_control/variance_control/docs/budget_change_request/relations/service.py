"""Relation service seed for budget_change_request."""
...
RELATED_DOCS = [{'doc_id': 'budget_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'variance_report', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'budget identity'}, {'description': 'totals from budget_plan'}]

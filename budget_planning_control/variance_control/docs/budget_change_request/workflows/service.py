"""Workflow service seed for budget_change_request."""
...
STATES = ['requested', 'in_review', 'approved', 'rejected', 'closed', 'archived']
TERMINAL_STATES = ['closed', 'archived']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': None}, 'submit': {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': 'in_review'}, 'review': {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': 'in_review'}, 'approve': {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': 'approved'}, 'reject': {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': 'rejected'}, 'close': {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': 'closed'}, 'archive': {'allowed_in_states': ['requested', 'in_review', 'approved', 'rejected'], 'transitions_to': 'archived'}}

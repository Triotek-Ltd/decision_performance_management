...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['budget_plan', 'budget_line', 'budget_change_request'], 'action_targets': {'create': None, 'review': 'reviewed', 'publish': 'published', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

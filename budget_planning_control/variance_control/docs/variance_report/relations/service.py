"""Relation service seed for variance_report."""
...
RELATED_DOCS = [{'doc_id': 'budget_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'budget_line', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'budget_change_request', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'budget scope'}, {'description': 'target amounts from budget_plan'}]

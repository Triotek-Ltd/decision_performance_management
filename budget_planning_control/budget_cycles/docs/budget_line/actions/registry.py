"""Action registry seed for budget_line."""
...
DOC_ID = "budget_line"
ALLOWED_ACTIONS = ['record', 'review', 'adjust', 'archive']
ACTION_RULES: dict[str, dict[str, Any]] = {'record': {'allowed_in_states': ['active', 'revised'], 'transitions_to': None}, 'review': {'allowed_in_states': ['active', 'revised'], 'transitions_to': None}, 'adjust': {'allowed_in_states': ['active', 'revised'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['active', 'revised'], 'transitions_to': 'archived'}}

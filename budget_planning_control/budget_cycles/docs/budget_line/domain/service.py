...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['budget_plan', 'variance_report'], 'action_targets': {'record': None, 'review': None, 'adjust': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['budget_line', 'variance_report', 'budget_change_request'], 'action_targets': {'create': None, 'submit': 'submitted', 'review': None, 'approve': 'approved', 'activate': 'active', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

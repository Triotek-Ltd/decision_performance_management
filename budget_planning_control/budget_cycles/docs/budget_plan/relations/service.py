"""Relation service seed for budget_plan."""
...
DOC_ID = "budget_plan"
RELATED_DOCS = [{'doc_id': 'budget_line', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'variance_report', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'budget_change_request', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

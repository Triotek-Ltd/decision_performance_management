...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['decision_case', 'risk_evaluation_record'], 'action_targets': {'create': None, 'review': 'reviewed', 'select': None, 'reject': 'rejected', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

"""Action handler seed for decision_option:reject."""
...
ACTION_ID = "reject"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'reviewed', 'selected', 'rejected'], 'transitions_to': 'rejected'}
...
ACTION_CONTRACT: dict[str, Any] = {'rule': {'allowed_in_states': ['draft', 'reviewed', 'selected', 'rejected'], 'transitions_to': 'rejected'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}

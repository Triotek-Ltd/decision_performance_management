"""Business-domain service seed for Risk Evaluation Record."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['decision_case', 'decision_option', 'performance_exception'], 'action_targets': {'create': None, 'review': 'reviewed', 'confirm': None, 'archive': 'archived'}, 'action_side_effects_file': None}

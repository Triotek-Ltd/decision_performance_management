"""Relation service seed for risk_evaluation_record."""
...
RELATED_DOCS = [{'doc_id': 'decision_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'decision_option', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'performance_exception', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'decision'}, {'description': 'option context from linked records'}]

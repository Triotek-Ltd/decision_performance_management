"""Relation service seed for decision_case."""
...
RELATED_DOCS = [{'doc_id': 'decision_option', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'risk_evaluation_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

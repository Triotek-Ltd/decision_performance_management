...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['decision_option', 'risk_evaluation_record'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'approve': 'approved', 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

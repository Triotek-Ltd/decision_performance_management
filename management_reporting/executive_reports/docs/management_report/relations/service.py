"""Relation service seed for management_report."""
...
RELATED_DOCS = [{'doc_id': 'executive_review', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'management_action_item', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'KPI'}, {'description': 'budget'}, {'description': 'project context from linked source reports where applicable'}]

"""Business-domain service seed for Management Report."""
...
ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'reviewed', 'approved', 'published', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'related_executive_review': 'relation_collection', 'related_management_action_item': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'report_code', 'report_type', 'reporting_period'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'reviewed', 'approved', 'published', 'archived'], 'terminal_states': ['archived'], 'records_profile': {'record_class': 'business_record', 'legal_significance': 'standard', 'confidentiality': 'internal', 'official_copy_format': 'pdf', 'evidence_gaps': []}, 'record_contract': {'doc_kind': 'transaction', 'supports_attachments': True, 'supports_comments': True, 'supports_activity_log': True, 'supports_assignments': True, 'is_submittable': False, 'supports_submission_snapshot': True, 'supports_official_outputs': True, 'supports_evidence_pack': True, 'supports_signoff': True}, 'submission_snapshot_policy': {'enabled': True, 'trigger_action': 'submit', 'freeze_fields_after_snapshot': True, 'retain_snapshot_history': True, 'snapshot_label_template': '{reference_no}-{workflow_state}', 'trigger_actions': ['submit']}, 'signature_policy': {'enabled': True, 'mode': 'approval', 'required_roles': ['System Manager'], 'reason_required': False, 'counter_signature_required': False}, 'audit_policy': {'track_state_history': True, 'track_action_log': True, 'track_external_refs': True, 'require_reason_for_change': False, 'require_action_comment': False, 'hash_official_outputs': False}, 'records_management': {'retention_policy_ref': 'administration.office_administration.filing_records_management.retention_disposal.retention_policy', 'legal_hold_enabled': False, 'disposition_action': 'archive', 'immutable_after_submit': True, 'official_copy_on_submit': False, 'chain_of_custody_required': False, 'retention_trigger_field': None, 'legal_hold_field': None, 'disposition_actions': ['archive']}, 'legal_hold_policy': {'enabled': False, 'hold_field': None, 'restrict_disposition_while_active': True, 'allow_override_roles': []}, 'official_copy_policy': {'enabled': True, 'format': 'pdf', 'generate_on_submit': False, 'hash_outputs': False, 'include_audit_summary': True, 'include_attachments_index': True, 'trigger_actions': []}, 'evidence_policy': {'required_attachments': [], 'required_references': [], 'required_approvals': [], 'verification_fields': []}, 'chain_of_custody_policy': {'enabled': False, 'custody_event_field': None, 'require_transfer_reason': False, 'require_actor_identity': True}, 'display_runtime_hints': {'doc_key': 'management_report', 'supports_related_lookup': True, 'supports_fetch_rules': True, 'action_side_effects_file': 'side_effects.json', 'supports_official_copy': True, 'supports_evidence_timeline': True, 'supports_chain_of_custody': False}, 'action_contracts': {'create': {'rule': {'allowed_in_states': ['draft', 'reviewed', 'approved', 'published'], 'transitions_to': None}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'review': {'rule': {'allowed_in_states': ['draft', 'reviewed', 'approved', 'published'], 'transitions_to': 'reviewed'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'approve': {'rule': {'allowed_in_states': ['draft', 'reviewed', 'approved', 'published'], 'transitions_to': 'approved'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': True}, 'publish': {'rule': {'allowed_in_states': ['draft', 'reviewed', 'approved', 'published'], 'transitions_to': 'published'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'archive': {'rule': {'allowed_in_states': ['draft', 'reviewed', 'approved', 'published'], 'transitions_to': 'archived'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': True, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}}, 'action_targets': {'create': None, 'review': 'reviewed', 'approve': 'approved', 'publish': 'published', 'archive': 'archived'}}

WORKFLOW_HINTS = {}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['executive_review', 'management_action_item'], 'action_targets': {'create': None, 'review': 'reviewed', 'approve': 'approved', 'publish': 'published', 'archive': 'archived'}, 'action_side_effects_file': None}

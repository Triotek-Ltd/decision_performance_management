...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['management_report', 'executive_review', 'team_checkin', 'performance_exception'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

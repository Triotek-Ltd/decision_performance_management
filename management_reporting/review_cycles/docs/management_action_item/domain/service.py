...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'due_date': 'schedule_marker', 'completion_note': 'completion_note'}, 'search_fields': ['title', 'reference_no', 'description', 'item_code', 'source_review_or_report', 'owner'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'assigned', 'in_progress', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'close': 'closed', 'archive': 'archived'}}

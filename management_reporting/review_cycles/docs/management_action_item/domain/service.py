"""Business-domain service seed for Management Action Item."""
...
ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['opened', 'assigned', 'in_progress', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'due_date': 'schedule_marker', 'completion_note': 'completion_note', 'related_management_report': 'relation_collection', 'related_executive_review': 'relation_collection', 'related_team_checkin': 'relation_collection', 'related_performance_exception': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'item_code', 'source_review_or_report', 'owner'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'assigned', 'in_progress', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'records_profile': {'record_class': 'business_record', 'legal_significance': 'standard', 'confidentiality': 'internal', 'official_copy_format': 'pdf', 'evidence_gaps': []}, 'record_contract': {'doc_kind': 'workflow_case', 'supports_attachments': True, 'supports_comments': True, 'supports_activity_log': True, 'supports_assignments': True, 'is_submittable': False, 'supports_submission_snapshot': True, 'supports_official_outputs': True, 'supports_evidence_pack': True, 'supports_signoff': False}, 'submission_snapshot_policy': {'enabled': True, 'trigger_action': 'submit', 'freeze_fields_after_snapshot': True, 'retain_snapshot_history': True, 'snapshot_label_template': '{reference_no}-{workflow_state}', 'trigger_actions': ['submit']}, 'signature_policy': {'enabled': False, 'mode': 'approval', 'required_roles': [], 'reason_required': False, 'counter_signature_required': False}, 'audit_policy': {'track_state_history': True, 'track_action_log': True, 'track_external_refs': True, 'require_reason_for_change': False, 'require_action_comment': False, 'hash_official_outputs': False}, 'records_management': {'retention_policy_ref': 'administration.office_administration.filing_records_management.retention_disposal.retention_policy', 'legal_hold_enabled': False, 'disposition_action': 'archive', 'immutable_after_submit': True, 'official_copy_on_submit': False, 'chain_of_custody_required': False, 'retention_trigger_field': None, 'legal_hold_field': None, 'disposition_actions': ['archive']}, 'legal_hold_policy': {'enabled': False, 'hold_field': None, 'restrict_disposition_while_active': True, 'allow_override_roles': []}, 'official_copy_policy': {'enabled': True, 'format': 'pdf', 'generate_on_submit': False, 'hash_outputs': False, 'include_audit_summary': True, 'include_attachments_index': True, 'trigger_actions': []}, 'evidence_policy': {'required_attachments': [], 'required_references': [], 'required_approvals': [], 'verification_fields': []}, 'chain_of_custody_policy': {'enabled': False, 'custody_event_field': None, 'require_transfer_reason': False, 'require_actor_identity': True}, 'display_runtime_hints': {'doc_key': 'management_action_item', 'supports_related_lookup': True, 'supports_fetch_rules': True, 'workflow_hints': {'relation_context': {'related_docs': ['management_report', 'executive_review', 'team_checkin', 'performance_exception'], 'borrowed_field_context': ['source issue or decision context from management_report or executive_review'], 'inferred_roles': ['Reviewer']}, 'actors': ['Reviewer'], 'action_actors': {'create': ['Reviewer'], 'assign': ['Reviewer'], 'track': ['Reviewer'], 'close': ['Reviewer'], 'archive': ['Reviewer']}}, 'action_side_effects_file': 'side_effects.json', 'supports_official_copy': True, 'supports_evidence_timeline': True, 'supports_chain_of_custody': False}, 'action_contracts': {'create': {'rule': {'allowed_in_states': ['opened', 'assigned', 'in_progress'], 'transitions_to': None}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'assign': {'rule': {'allowed_in_states': ['opened', 'assigned', 'in_progress'], 'transitions_to': 'in_progress'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'track': {'rule': {'allowed_in_states': ['opened', 'assigned', 'in_progress'], 'transitions_to': None}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'close': {'rule': {'allowed_in_states': ['opened', 'assigned', 'in_progress'], 'transitions_to': 'closed'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'archive': {'rule': {'allowed_in_states': ['opened', 'assigned', 'in_progress'], 'transitions_to': 'archived'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': True, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}}, 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'close': 'closed', 'archive': 'archived'}}

WORKFLOW_HINTS = {'relation_context': {'related_docs': ['management_report', 'executive_review', 'team_checkin', 'performance_exception'], 'borrowed_field_context': ['source issue or decision context from management_report or executive_review'], 'inferred_roles': ['Reviewer']}, 'actors': ['Reviewer'], 'action_actors': {'create': ['Reviewer'], 'assign': ['Reviewer'], 'track': ['Reviewer'], 'close': ['Reviewer'], 'archive': ['Reviewer']}}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['management_report', 'executive_review', 'team_checkin', 'performance_exception'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': None}

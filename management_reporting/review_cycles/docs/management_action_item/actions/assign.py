"""Action handler seed for management_action_item:assign."""
...
ACTION_ID = "assign"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'assigned', 'in_progress'], 'transitions_to': 'in_progress'}
...
ACTION_CONTRACT: dict[str, Any] = {'rule': {'allowed_in_states': ['opened', 'assigned', 'in_progress'], 'transitions_to': 'in_progress'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}

"""Relation service seed for management_action_item."""
...
RELATED_DOCS = [{'doc_id': 'management_report', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'executive_review', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'team_checkin', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'performance_exception', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source issue or decision context from management_report or executive_review'}]

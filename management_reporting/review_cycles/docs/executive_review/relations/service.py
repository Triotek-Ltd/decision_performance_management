"""Relation service seed for executive_review."""
...
RELATED_DOCS = [{'doc_id': 'management_report', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'management_action_item', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'report identity'}, {'description': 'audience from management_report'}]

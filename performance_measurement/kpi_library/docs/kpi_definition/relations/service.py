"""Relation service seed for kpi_definition."""
...
RELATED_DOCS = [{'doc_id': 'scorecard_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'performance_exception', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'alert_rule', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['scorecard_record', 'performance_exception', 'alert_rule'], 'action_targets': {'create': None, 'update': None, 'review': None, 'approve': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

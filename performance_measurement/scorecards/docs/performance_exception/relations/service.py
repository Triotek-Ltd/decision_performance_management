"""Relation service seed for performance_exception."""
...
RELATED_DOCS = [{'doc_id': 'kpi_definition', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'scorecard_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'management_action_item', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'threshold'}, {'description': 'metric context from kpi_definition'}]

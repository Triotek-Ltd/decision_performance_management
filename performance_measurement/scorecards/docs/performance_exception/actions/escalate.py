"""Action handler seed for performance_exception:escalate."""
...
ACTION_ID = "escalate"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['raised', 'reviewed', 'correcting', 'escalated'], 'transitions_to': 'escalated'}

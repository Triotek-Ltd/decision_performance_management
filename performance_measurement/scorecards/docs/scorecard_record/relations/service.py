"""Relation service seed for scorecard_record."""
...
RELATED_DOCS = [{'doc_id': 'kpi_definition', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'performance_exception', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'KPI targets'}, {'description': 'names from kpi_definition'}]

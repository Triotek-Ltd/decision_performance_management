"""Action registry seed for scorecard_record."""
...
ALLOWED_ACTIONS = ['create', 'review', 'finalize', 'archive']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['draft', 'reviewed', 'finalized'], 'transitions_to': None}, 'review': {'allowed_in_states': ['draft', 'reviewed', 'finalized'], 'transitions_to': 'reviewed'}, 'finalize': {'allowed_in_states': ['draft', 'reviewed', 'finalized'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'reviewed', 'finalized'], 'transitions_to': 'archived'}}

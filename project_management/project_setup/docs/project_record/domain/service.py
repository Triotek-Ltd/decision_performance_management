...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['project_plan', 'project_task', 'project_status_report'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

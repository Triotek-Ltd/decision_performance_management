"""Relation service seed for project_record."""
...
RELATED_DOCS = [{'doc_id': 'project_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'project_task', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'project_status_report', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

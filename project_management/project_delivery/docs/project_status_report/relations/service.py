"""Relation service seed for project_status_report."""
...
RELATED_DOCS = [{'doc_id': 'project_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'project_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'project_task', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'project identity'}, {'description': 'owner from project_record'}]

"""Business-domain service seed for Project Status Report."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['project_record', 'project_plan', 'project_task'], 'action_targets': {'create': None, 'review': 'reviewed', 'publish': 'published', 'archive': 'archived'}, 'action_side_effects_file': None}

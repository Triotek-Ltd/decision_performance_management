...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['project_record', 'project_plan', 'project_status_report'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'block': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

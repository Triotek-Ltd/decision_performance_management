"""Relation service seed for project_task."""
...
DOC_ID = "project_task"
RELATED_DOCS = [{'doc_id': 'project_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'project_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'project_status_report', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'project scope'}, {'description': 'milestone context from project_plan'}]
